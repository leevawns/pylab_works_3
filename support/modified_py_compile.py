...
# MODIFIED py_compile by Stef Mientki (SM)
# can be used with memory buffer instead of file
...
# MODIFIED SM
#def compile( file = None, cfile=None, dfile=None, doraise=False):
...
def main(args=None):
    ...
    for filename in args:
        #print("filename in main():",filename)
        try:
