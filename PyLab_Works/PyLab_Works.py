...
class Pylab_Work_MainForm ( wx.Frame ) :
  ...
  def __init__(self, inifile = None):
    ...
    # *************************************************************
    menus = default_menus_pylab_works
    ...
    self.SetIcon ( wx.Icon(Joined_Paths ( Path,'../pictures/vippi_bricks_323.ico'), wx.BITMAP_TYPE_ICO))
...
# ***********************************************************************
# ***********************************************************************
class Pylab_Work_MainForm_test ( wx.Frame ) :
  ...
  def __init__(self, inifile = None):
    ...
    #
    # *************************************************************
    wx.Frame.__init__( self, None, -1,PG.Program_Name + ' (V '+ PG.Version_Nr + ')     no active project   ',pos=(0,0), size=(800,600))
...
if __name__ == "__main__":
  try :
    ...
    #***********************************
    PG.Main_Form = Pylab_Work_MainForm_test ( )
