...
# *************************************************
# *************************************************
def Clear_Arrows ( Value = None ) :
  global Arrows, Bvector
  for arrow in Arrows :
    arrow.visible = False
...
# *************************************************
VPC.Define ( 1 )
VPC.Set_Button ( 0, 'Clear', Clear_Arrows )
...
while True:
    ...
    ##            scene.cursor.visible = 1 # not yet implemented
                new = arrow(pos=obs, axis=Bscale*BField(obs), shaftwidth=vwidth, color=(0,1,1))
                Arrows.append ( new )
