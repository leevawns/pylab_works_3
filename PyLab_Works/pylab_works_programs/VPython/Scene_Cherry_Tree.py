...
ai=0
aim=f*100
print """  Cherry_Tree, by Viktor Ferenczi, januari 2003
It would be interesting to change the program in such a way
that after a while the cherries would really drop on the ground.
"""

Forward_Up ( None, None, 3 )
