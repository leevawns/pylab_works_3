        ...
        if scene.mouse.events:
            ...
            if m.click == "left":
                if m.pick != None:
                    ...
                    spinAxis=(ax,ay,az)
                    spinOrig=(ox,oy,oz)
                    #print "spin axis = ", spinAxis
                    #print "spinOrig = ", spinOrig
                    #print "angleRep = ", angleRep
                    #print "angleRot = ", angleRot
                    print "m.pick.pos = ", m.pick.pos
                    #print "m.pickpos = ", m.pickpos
                    print "temp1 = ", temp1
